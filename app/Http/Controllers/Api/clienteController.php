...
class clienteController extends Controller
{
    public function login(Request $request)
    {
        ...
        $cliente = Cliente::where('correo_electronico', $credenciales['correo_electronico'])->first();

        if ($cliente && Hash::check($credenciales['contrasena'], $cliente->contrasena)) {
            $token = $cliente->createToken('API Cliente Token')->plainTextToken;
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            "correo_electronico" => "required|email|max:255|unique:cliente",
